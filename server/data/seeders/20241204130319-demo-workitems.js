  ...
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        { id: 3, task_id: 3, name: "Работен елемент 3", start_date: new Date(), end_date: null, activity_id: 1, measure_id: 2, artisan_id: 1, quantity: 13.0, manager_price: 1300.0, artisan_price: 1000.0, note: "Забележка3", finished_work: "Завършена работа", status: "in_progress", isInvoiced: false },
        ...
        { id: 11, task_id: 11, name: "Работен елемент 11", start_date: new Date(), end_date: null, activity_id: 1, measure_id: 1, artisan_id: 5, quantity: 21.0, manager_price: 2100.0, artisan_price: 1600.0, note: "Забележка11", finished_work: "Завършена работа", status: "in_progress", isInvoiced: false },
