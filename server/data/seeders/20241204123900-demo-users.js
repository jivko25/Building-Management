...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const hashedAccountantPassword = await bcrypt.hash("accountant123", saltRounds);
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        { id: 4, full_name: "Счетоводител Счетоводителов", username: "accountant", email: "accountant@example.com", hashedPassword: hashedAccountantPassword, role: "accountant", status: "active", manager_id: 1, creator_id: 1 }
      ],
      {}
    );
  },
