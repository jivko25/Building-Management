    ...
    <FormProvider {...form}>
      <form id="measure-form" onSubmit={form.handleSubmit(handleSubmit)}>
        <div className="grid grid-cols-1 gap-2 mb-2">
          <FormFieldInput type="text" label={t("Measure type")} name="name" className="pl-10" Icon={Ruler} />
        </div>
        <DialogFooter disabled={!form.formState.isDirty || isPending} label={t("Submit")} formName="measure-form" className="mt-6" />
      </form>
    </FormProvider>
  );
};
