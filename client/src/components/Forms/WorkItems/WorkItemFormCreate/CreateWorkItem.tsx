//client\src\components\Forms\WorkItems\WorkItemFormCreate\CreateWorkItem.tsx
...
const CreateWorkItem = () => {
  ...
  return <DialogModal Component={CreateWorkItemForm} CreateButtonModal props={{ handleSubmit, isPending }} isOpen={isOpen} setIsOpen={setIsOpen} createButtonTitle="Add new work item" title="New work item" />;
};
